        ...
        <div className="fade-in">
          ...
          <section className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-between pointer-events-none">
              <img
                src="https://i.ibb.co/NTZmhzL/Screenshot-710.png"
                alt="Hero Background"
          ...
          <section className="py-8 md:py-16 px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-xl md:text-2xl font-light text-center mb-6 md:mb-8" style={{ fontFamily: 'Onyx, sans-serif', fontSize: '28px' }}>Featured Video</h2>
          ...
          <section className="py-8 md:py-16 px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-xl md:text-2xl font-light text-center mb-6 md:mb-8" style={{ fontFamily: 'Onyx, sans-serif', fontSize: '28px' }}>Lookbook</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                {[
                  ...
                  <Link to="/shop" key={category.name} className="group">
                    <div className="h-[150px] md:h-[400px] bg-zinc-900 mb-2 md:mb-3 product-card"></div>
